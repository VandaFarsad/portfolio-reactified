    ...
    >
      ...
      <div className="w-full pt-8 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-16">
        <img
          ...
          alt="portrait"
        />
        <article className="max-w-xs sm:max-w-sm mx-auto lg:max-w-xl p-6 bg-white border border-gray-200 rounded-lg shadow-2xl shadow-slate-300">
          ...
          <p>
            ...
            unterstützen. 
            <br /><br />
            Lass uns gemeinsam neue und effiziente Lösungen entwickeln, die den Zielen deines Unternehmens
            entsprechen.
          </p>
        </article>
      </div>
