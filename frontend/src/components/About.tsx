  ...
  return (
    ...
    >
      ...
      <div className="w-full pt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 pb-6 items-stretch">
        <div className="flex">
          <img
            className="rounded-2xl shadow-2xl shadow-slate-300 max-w-xs mx-auto sm:max-w-sm lg:mr-4 object-cover self-stretch"
            src={photo}
            alt="portrait"
          />
        </div>
        <article className="max-w-xs mx-auto sm:max-w-sm lg:max-w-xl lg:ml-4 p-6 bg-white border border-gray-200 rounded-lg shadow-2xl shadow-slate-300 flex flex-col">
          <h2 className="mb-4 text-xl sm:text-2xl font-bold tracking-tight text-gray-900">Hey!</h2>
          <p className="text-sm lg:text-base xl:text-lg  lg:max-h-18 flex-grow">
            ...
            <br />
            <br />
            Lass uns gemeinsam innovative und wirkungsvolle Lösungen für deine Arbeitsprozesse entwickeln.
          </p>
        </article>
      </div>
    </section>
