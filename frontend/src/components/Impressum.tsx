  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-6">
        ...
        <address className="mt-2 text-gray-700 block">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold mb-4">Disclaimer - rechtliche Hinweise</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4">Disclaimer (Haftungsausschluss)</h2>
        <p className="mb-4">
